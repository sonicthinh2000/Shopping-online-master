...
module.exports = {
    up: async(queryInterface, Sequelize) => {
        let data = [
            ...
            { username: "test5@shopping.com", password: "$2a$10$T1BNcd9fiOA6mhHaWXBNrO8FhtnKGndMqznlcLsjPkYwGtFbJCujK", fullname: "Tester 5", avatarPath: '../img/user/ava5.jpg', isAdmin: false }
        ];
        data.map(item => {
